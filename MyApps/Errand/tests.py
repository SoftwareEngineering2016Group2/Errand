...
class ViewsTestCase(TestCase):
	...
	def TaskSteps(self):
		...
		mytask = simplejson.loads(getData('seetask', {'pk':mytask['pk']}))[0]
		self.assertEqual(mytask['fields']['headline'], task[1]['headline'])
	...
	def test(self):
		...
		self.Browse()
		self.Search()
		print(simplejson.loads(getData('getuserprofile', {'username':account[0]['username']})))
		print(simplejson.loads(getData('getuserprofile', {'username':account[1]['username']})))